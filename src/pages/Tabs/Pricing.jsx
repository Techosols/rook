        ...
        <div>
          ...
          <ul className="w-full max-w-2xl text-left">
            <div className="flex gap-2">
              ...
              <li className="py-2">
                It costs $10 to sign up and use Rook for one month. This
                includes the fee charged by the third-party background check
                processor, to perform the check.
              </li>
            </div>
            <div className="flex gap-2">
              <p className="mt-2">
        ...
        <div>
          ...
          <ul className="w-full max-w-2xl text-left">
            ...
            <div className="flex gap-2">
              ...
              <li className="py-2">
                You can cancel your Rook subscription anytime, in your account
                settings.
              </li>
            </div>
          </ul>
