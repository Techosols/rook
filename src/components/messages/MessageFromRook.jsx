...
function MessageFromRook() {
  const { rookMessages = [], loading } = useChat();

  return (
    <Section
      title="Messages from Rook"
      description="You can delete a message to remove it from the list."
    >
      {loading && (
      ...
      {!loading && (!rookMessages || rookMessages.length === 0) && (
          ...
          <div className="flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div className="w-full max-w-sm space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      Updates about your account and features
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-purple-100/50 dark:from-purple-900/20 dark:to-purple-800/10 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                <div className="flex items-start gap-3">
                  <Trash2 className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-0.5" />
                  <div className="text-left">
                    <p className="text-sm font-semibold text-gray-900 dark:text-white">
                      Manage Messages
                    </p>
