...
function ProfileSuggestionsByYou() {
  const { suggestionByYou = [], loading } = useChat();

  return (
    <Section
      title="Profile Suggestions By You"
      description="You left a suggestion for another user but they haven't responded yet."
    >
      {loading && (
      ...
      {!loading && !suggestionByYou.length && (
          ...
          <div className="flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-sm">
                You haven't suggested any profiles yet. Start suggesting
                profiles to users you think might be a great match!
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-sm">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/10 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                <div className="flex items-start gap-3">
                  <SendIcon className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5" />
      ...
      {!loading && suggestionByYou.length > 0 && (
