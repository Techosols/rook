...
function RookNotifications() {
  const { rookNotifications } = useChat();
  
  return (
    <>
      <Section title="Notifications" description="Latest updates from Rook">
        {!rookNotifications || rookNotifications.length === 0 ? (
              ...
              <div className="w-full max-w-sm space-y-3">
                <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/10 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Smart Notifications</p>
                      <p className="text-xs text-gray-600 dark:text-gray-400">We only notify you about what matters most</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-800/10 rounded-lg p-4 border border-emerald-200 dark:border-emerald-800">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Stay Updated</p>
                      <p className="text-xs text-gray-600 dark:text-gray-400">New matches, messages, and suggestions</p>
                    </div>
                  </div>
                </div>
              </div>
