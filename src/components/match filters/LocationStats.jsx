      ...
      <FormSection title="Stats">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 gap-y-4 md:gap-y-6">
          <div className="">
            ...
            <Input type="number" placeholder="e.g., 25" value={ageFrom} onChange={(e) => setAgeFrom(e.target.value)} error={((ageFrom < 18 && ageFrom !== '') ? 'Age must be at least 18' : undefined)} />
          </div>
          <div>
            <label className="block font-bold text-gray-700 dark:text-gray-300 mb-1">Age to - <span className="text-gray-500 font-normal">(Max 80 years)</span></label>
            <Input type="number" placeholder="e.g., 35" value={ageTo} onChange={(e) => setAgeTo(e.target.value)} error={((ageTo > 80 && ageTo !== '') ? 'Invalid age - (Max 80 years)' : undefined)} />
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Input type="number" placeholder="Feet" className="w-24" value={heightFromFeet} onChange={(e) => setHeightFromFeet(e.target.value)} />
              <Input type="number" placeholder="Inches" className="w-24" value={heightFromInches} onChange={(e) => setHeightFromInches(e.target.value)} />
            </div>
          </div>
          <div>
            ...
            <div className="flex items-center gap-2">
              <Input type="number" placeholder="Feet" className="w-24" value={heightToFeet} onChange={(e) => setHeightToFeet(e.target.value)} />
              <Input type="number" placeholder="Inches" className="w-24" value={heightToInches} onChange={(e) => setHeightToInches(e.target.value)} />
            </div>
          </div>
          <div>
            <label className="block font-bold text-gray-700 dark:text-gray-300 mb-1">Minimum Education Level</label>
            <Select options={educationLevels} value={educationLevel} onChange={(e) => setEducationLevel(e.target.value)} />
          </div>
        </div>
      </FormSection>
      ...
      <FormSection title="Health/Habits">
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_4fr] gap-1 md:gap-2 items-center">
            ...
            <Select options={alcoholConsumptionFrequencies} value={maximumAlcoholConsumption} onChange={setMaximumAlcoholConsumption} />
          </div>
        </div>
      </FormSection>
